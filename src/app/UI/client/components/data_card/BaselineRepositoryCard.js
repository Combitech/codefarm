                ...
                <If condition={this.state.expanded.value}>
                    <table className={this.props.theme.table}>
                        <tbody>
                            ...
                            <tr>
                                <td>Initial Baseline Tags</td>
                                <td>
                                    <Tags list={this.props.item.initialBaselineTags} />
                                </td>
                            </tr>
                            <tr>
                                <td>Tags</td>
...
BaselineRepositoryCard.defaultProps = {
    expanded: false,
    expandable: true,
    clickable: false
};

BaselineRepositoryCard.propTypes = {
...
export default BaselineRepositoryCard;
