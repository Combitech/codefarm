...
import { BaselineRepositoryCard } from "ui-components/data_card";
...
import BaselineRepositoryFlowList from "ui-observables/baseline_repository_flows";
import BaselineRepoBaselineList from "ui-observables/paged_baselinerepo_baseline_list";

class ListTabs extends LightComponent {
    constructor(props) {
        super(props);
        this.flows = new BaselineRepositoryFlowList({
            ...
            >
                <Container>
                    <Choose>
                        ...
                        <Otherwise>
                            <Header label="Baselines" />
                            <List
                                key={"baselines"}
                                ObservableList={BaselineRepoBaselineList}
